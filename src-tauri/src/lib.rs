...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::commands::fastboot_getvar,
            ipc::commands::fastboot_set_slot,
            ipc::commands::fastboot_boot,
            ipc::commands::backup_external_data,
            ipc::commands::backup_sdcard,
